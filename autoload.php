...
$classmap['actionscheduler_recurringactionscheduler'] = __DIR__ . '/classes/ActionScheduler_RecurringActionScheduler.php';
...
require __DIR__ . '/functions/as_supports.php'; // as_supports
